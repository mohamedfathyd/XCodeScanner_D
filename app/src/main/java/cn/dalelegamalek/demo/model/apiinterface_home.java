...
public interface apiinterface_home {
    ...
    @FormUrlEncoded
    @POST("montag/dallejamalk/Gmalek_service_provider.php")
    ...
    @FormUrlEncoded
    @POST("montag/dallejamalk/Gmalek_login_service_provider.php")
    Call<List<contact_home>>getcontacts_login(@Field("phonee") String phonee, @Field("password") String password);
    @FormUrlEncoded
    @POST("montag/dallejamalk/Gmalek_add_order.php")
    ...
    @FormUrlEncoded
    @POST("montag/dallejamalk/Gmalek_get_provider_orders.php")
    Call<List<contact_order>>getcontacts_order(@Field("id") int id);
    @FormUrlEncoded
    @POST("montag/dallejamalk/Gmalek_delete_order.php")
